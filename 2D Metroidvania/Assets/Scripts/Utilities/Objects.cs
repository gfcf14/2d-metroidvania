...
public class Objects {
  ...
  public static Dictionary<string, PauseItem> pauseItems = new Dictionary<string, PauseItem> {
    ...
    {"lance", new PauseItem(Sprites.itemThumbnails[14], Sprites.itemImages[14], "Lance", "Said to require twice the skill to handle compared to a sword.", "throwable", new Effects() {atk=60})},
    {"axe", new PauseItem(Sprites.itemThumbnails[15], Sprites.itemImages[15], "Axe", "Dual edged for maximum damage and reach.", "throwable", new Effects() {atk=40})},
    ...
    {"bow", new PauseItem(Sprites.itemThumbnails[21], Sprites.itemImages[21], "Standard Bow", "Your basic archery bow.", "bow", new Effects() {atk=10})},
    ...
    {"bomb", new PauseItem(Sprites.itemThumbnails[25], Sprites.itemImages[25], "Bomb", "Paper-based weapon of Asian manufacture with high explosive power.", "bomb", new Effects() {atk=100})}
