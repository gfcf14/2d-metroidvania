...
public class Objects {
  ...
  public static Dictionary<string, PauseItem> pauseItems = new Dictionary<string, PauseItem> {
    ...
    {"earth-med", new PauseItem(Sprites.itemThumbnails[49], Sprites.itemImages[49], "Earth Medicine", "Provides resistance against earth magic.", "", new Effects() {magicResistances=new MagicResistance[]{new MagicResistance(){name="Earth", type="add"}}})},
    {"air-med", new PauseItem(Sprites.itemThumbnails[50], Sprites.itemImages[50], "Air Medicine", "Provides resistance against air magic.", "", new Effects() {magicResistances=new MagicResistance[]{new MagicResistance(){name="Air", type="add"}}})},
    {"water-med", new PauseItem(Sprites.itemThumbnails[51], Sprites.itemImages[51], "Water Medicine", "Provides resistance against water magic.", "", new Effects() {magicResistances=new MagicResistance[]{new MagicResistance(){name="Water", type="add"}}})},
    {"fire-med", new PauseItem(Sprites.itemThumbnails[52], Sprites.itemImages[52], "Fire Medicine", "Provides resistance against fire magic.", "", new Effects() {magicResistances=new MagicResistance[]{new MagicResistance(){name="Fire", type="add"}}})},
    {"lightning-med", new PauseItem(Sprites.itemThumbnails[53], Sprites.itemImages[53], "Lightning Medicine", "Provides resistance against lightning magic.", "", new Effects() {magicResistances=new MagicResistance[]{new MagicResistance(){name="Lightning", type="add"}}})},
    {"ice-med", new PauseItem(Sprites.itemThumbnails[54], Sprites.itemImages[54], "Ice Medicine", "Provides resistance against ice magic.", "", new Effects() {magicResistances=new MagicResistance[]{new MagicResistance(){name="Ice", type="add"}}})},
    {"light-med", new PauseItem(Sprites.itemThumbnails[55], Sprites.itemImages[55], "Light Medicine", "Provides resistance against light magic.", "", new Effects() {magicResistances=new MagicResistance[]{new MagicResistance(){name="Light", type="add"}}})},
    {"dark-med", new PauseItem(Sprites.itemThumbnails[56], Sprites.itemImages[56], "Dark Medicine", "Provides resistance against dark magic.", "", new Effects() {magicResistances=new MagicResistance[]{new MagicResistance(){name="Dark", type="add"}}})},
    ...
    {"apple", new PauseItem(Sprites.itemThumbnails[58], Sprites.itemImages[58], "Apple", "Tasty red fruit found pretty much everywhere.", "consumable", new Effects() {hp=20})},
    {"banana", new PauseItem(Sprites.itemThumbnails[59], Sprites.itemImages[59], "Banana", "Yellow, really tasty when ripe. Goes well with bread.", "consumable", new Effects() {hp=20})},
    {"orange", new PauseItem(Sprites.itemThumbnails[60], Sprites.itemImages[60], "Orange", "May be sweet but also sometimes a bit bitter.", "consumable", new Effects() {hp=20})},
    {"pear", new PauseItem(Sprites.itemThumbnails[61], Sprites.itemImages[61], "Pear", "Hard on the outside but soft on the inside.", "consumable", new Effects() {hp=20})},
    {"strawberry", new PauseItem(Sprites.itemThumbnails[62], Sprites.itemImages[62], "Strawberry", "Small but flavorful. Really tasty with cake.", "consumable", new Effects() {hp=10})},
    {"cherry", new PauseItem(Sprites.itemThumbnails[63], Sprites.itemImages[63], "Cherry", "Somewhat sour. Great as a pie filling.", "consumable", new Effects() {hp=10})},
    {"grapes", new PauseItem(Sprites.itemThumbnails[64], Sprites.itemImages[64], "Grapes", "Great as a snack. Beware of seeds.", "consumable", new Effects() {hp=10})},
    {"pineapple", new PauseItem(Sprites.itemThumbnails[65], Sprites.itemImages[65], "Pineapple", "Tropical fruit with a sweet but tangy flavor.", "consumable", new Effects() {hp=50})},
    {"mango", new PauseItem(Sprites.itemThumbnails[66], Sprites.itemImages[66], "Mango", "Delicious fruit with an edible peel.", "consumable", new Effects() {hp=20})},
    {"coconut", new PauseItem(Sprites.itemThumbnails[67], Sprites.itemImages[67], "Coconut", "Tropical fruit with a hard surface. Can be thrown.", "consumable", new Effects() {hp=50})},
    {"honeydew", new PauseItem(Sprites.itemThumbnails[68], Sprites.itemImages[68], "Honeydew", "Tasty melon with a green flesh. Can be thrown.", "consumable", new Effects() {hp=80})},
    {"watermelon", new PauseItem(Sprites.itemThumbnails[69], Sprites.itemImages[69], "Watermelon", "Refreshing melon with a red flesh. Can be thrown to get slices.", "consumable", new Effects() {hp=100})},
    {"watermelon-slice", new PauseItem(Sprites.itemThumbnails[70], Sprites.itemImages[70], "Watermelon Slice", "Refreshing watermelon slice ideal for snacking.", "consumable", new Effects() {hp=20})},
    ...
    {"wine", new PauseItem(Sprites.itemThumbnails[92], Sprites.itemImages[92], "Wine", "Brewed to perfection for a long time.", "consumable", new Effects() {hp=100, mp=-20})},
