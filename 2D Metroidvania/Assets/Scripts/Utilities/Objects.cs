...
public class Objects {
  ...
  public static Dictionary<string, EnemyStats> enemyStats = new Dictionary<string, EnemyStats> {
    {"dwarf", new EnemyStats() {name = "Dwarf", type = "patroller", baseMaterial = "boots", normalAttackType = "kick", hp = 50, atk = 20, def = 80, crit = 0.05f, exp = 30, speed= 5, reach = 0.5f, edgeCastLength = 0.5f, arrowBurnPosition = 0.7f}},
    ...
    {"pixie", new EnemyStats() {name = "Pixie", type = "patroller", baseMaterial = "barefoot", normalAttackType = "punch", hp = 100, atk = 10, def = 60, crit = 0.01f, exp = 100, speed= 3, reach = 0.25f, edgeCastLength = 1, arrowBurnPosition = 0.4f}},
